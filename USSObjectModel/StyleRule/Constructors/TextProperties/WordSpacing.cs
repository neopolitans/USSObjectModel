    ...
    namespace Interpreters
    {
        namespace Languages
        {
            namespace USS
            {
                ...
                {
                    /// <summary>
                    /// Create a Word-Spacing Rule with the 'normal' keyword as the default value. <br></br><br></br>
                    ...
                    /// </summary>
                    public static StyleRule WordSpacing()
                    {
                        return new StyleRule(RuleType.wordSpacing, "normal");
                    }

                    /// <summary>
                    /// Create a Word-Spacing Rule with an integer value which gets created into a length (pixels) value. <br></br><br></br>
